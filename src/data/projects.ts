...
export const projects: Project[] = [
  ...
  { id: 'desa-relau-ii', name: 'Desa Relau II', category: 'residential', location: 'Lebuh Relau 2, Penang', type: 'Condominium', condition: '1999 year condominium', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&q=80', description: 'Full condo renovation revitalizing a 1999 unit with contemporary finishes, smart storage, and refreshed M&E systems.' },
  ...
  { id: 'zen-6', name: 'Zen 6', category: 'residential', location: 'Persiaran Bayan Mutiara, Bayan Lepas, Penang', type: 'Condominium', condition: '2023 year condominium', image: 'https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=800&q=80', description: 'Minimalist zen-inspired condo design with clean lines, natural textures, and 3D-to-built accuracy.' },
  ...
  { id: 'hair-story-butterworth', name: 'Hair Story — Butterworth', category: 'commercial', location: 'Butterworth Business City Centre, Butterworth', type: 'Shoplot', condition: 'Bare unit', image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&q=80', description: 'Brand-new salon fit-out from bare unit with custom reception, wash stations, and retail display.' },
  { id: 'hair-story-gurney', name: 'Hair Story — Gurney Walk', category: 'commercial', location: 'Gurney Walk, Persiaran Gurney, Penang', type: 'Boutique Retail Mall', condition: 'Bare unit', image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&q=80', description: 'High-traffic mall outlet designed for maximum brand visibility and operational efficiency.' },
  { id: 'hair-story-prima', name: 'Hair Story — Prima Tanjung', category: 'commercial', location: 'Prima Tanjung, Penang', type: 'Shoplot', condition: 'Refurbish', image: 'https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?w=800&q=80', description: 'Salon refresh with updated colour palette, lighting design, and improved workflow for stylists.' },
...
export const services = [
  ...
  { id: 'carpentry', title: 'Custom Carpentry', description: 'In-house fabrication of bespoke furniture, cabinetry, and built-in solutions for any space.', image: 'https://images.unsplash.com/photo-1615529328331-f8917597711f?w=800&q=80', icon: 'Ruler' },
