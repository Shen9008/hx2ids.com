  ...
  return (
    <section ref={ref} className="relative min-h-[100svh] overflow-hidden">
      <motion.div style={{ y }} className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-graphite-800/75 via-graphite-700/45 to-graphite-800/65" />
      </motion.div>

      <ShaderBackground variant="hero" className="mix-blend-soft-light" opacity={0.55} />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(184,168,138,0.12),transparent_50%)]" />
