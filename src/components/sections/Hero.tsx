  ...
  return (
    <section ref={ref} className="relative min-h-[100svh] overflow-hidden">
      <motion.div style={{ y }} className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-graphite-800/80 via-graphite-700/50 to-graphite-800/70" />
      </motion.div>

      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(184,168,138,0.15),transparent_50%)]" />

      <motion.div style={{ opacity }} className="relative flex min-h-[100svh] flex-col justify-center px-4 pb-32 pt-28 sm:px-6">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <Link to="/projects">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full border-white/40 bg-white/5 text-white backdrop-blur-sm hover:bg-white hover:text-graphite-800 sm:w-auto"
                >
                  View Our Work
                </Button>
              </Link>
      ...
      <div className="absolute inset-x-0 bottom-0 border-t border-white/10 bg-beige-100/95 backdrop-blur-xl">
