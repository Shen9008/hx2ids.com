      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-graphite-700 px-8 py-16 text-center sm:px-16"
          >
            <ShaderBackground variant="dark" opacity={0.9} />
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(184,168,138,0.15),transparent_60%)]" />
