      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-graphite-800 px-6 py-12 text-center sm:px-16 sm:py-16"
          >
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-4 max-w-md text-base text-beige-200/75 sm:text-lg">{description}</p>
